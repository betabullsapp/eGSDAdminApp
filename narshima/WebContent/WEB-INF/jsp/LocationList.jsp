				...
				<table class="table bordered striped searchResults">
					<tbody class="tbody">
						...
						<c:forEach var="selectLocObj" items="${selectLocObj}">
							<tr>
								<td style="padding: 6px 0px 0px 30px;"> <a onclick='loading()' style="color:#337ab7" href="select?user=${user}&userName=${userName}&locId=${selectLocObj.directory}">
								${selectLocObj.name}
								</a>
								</td>
...
<body class="loaded" onload="bodyLoad()"
	...
	<div class="navbar-fixed cyan">
		...
		<li><a  id="updateAdminDetails"style="font-size: 1rem; padding: 0.5rem 0.5rem;">Manage My Profile</a></li>
		<li><a  id="changePasswordDetails"style="font-size: 1rem; padding: 0.5rem 0.5rem;">Change My Password</a></li>
			...
			<li><a  id="acAdmin" style="font-size: 1rem; padding: 0.5rem 0.5rem;">Add CS Admin User</a></li>
   			<li><a id="alAdmin"	style="font-size: 1rem; padding: 0.5rem 0.5rem;">Add Hotel Admin User</a></li>
   			<li><a href="#modal4" class="modal-trigger searchUsers"
				style="font-size: 1rem; padding: 0.5rem 0.5rem;">Manage Users</a></li>
				<li> <a id="agroup"	style="font-size: 1rem; padding: 0.5rem 0.5rem;">Create Hotel Group</a></li>
   			<li><a href="#modal3" class="modal-trigger skipGroup"
				style="font-size: 1rem; padding: 0.5rem 0.5rem;">Manage Hotel Groups</a></li>
    		<li><a id="ctemplate" style="font-size: 1rem; padding: 0.5rem 0.5rem;">Create Template</a></li>
    		<li><a href="#modal2" class="modal-trigger skipTemplate"
				style="font-size: 1rem; padding: 0.5rem 0.5rem;">Manage Templates</a></li>
			<li><a id="ahotel"	style="font-size: 1rem; padding: 0.5rem 0.5rem;">Create Hotel</a></li> -->
...
<!--  end of the update Super admin popup -->
	...
	<a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat right">Close</a>
		<center style="margin-left:15%"><h5>Managing Users</h5></center>
	      ...
	      <div class="modal-content">
	         ...
	         <center><h5 > Create Hotel </h5></center>
	        		<div style="margin: 1% 3% 0px 3%">
							...
							<div class="">
								<div class="input-field ">
									<a href="javascript: hotelSubmitform()" class="btn ">Add Hotel</a>
   ...
   <a href="#!" class=" modal-action modal-close right waves-effect waves-green btn-flat">Close</a>
    ...
    <div class="input-field ">
     ...
     <span id="groupIdErr" style="color:red;font-size:13px"></span>
       ...
       <center style="margin-top:5%"><a href="javascript: groupSubmitform()" class="waves-effect waves-light btn">Create Hotel Group </a></center>
...
<!-- success change password popup -->
 ...
 <!--  create Add Super admin popup -->
  ...
  <div id="superAdmin" class="modal">
   ...
   <%-- <form:form action="registerSuperAdmin?user=${user}&userName=${userName}&locId=${locObj.objectId}" method="post" > --%>
    <a href="#!" class=" modal-action modal-close right waves-effect waves-green btn-flat">Close</a>
       <div class="modal-content sbody" >
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="firstname" id="superFirstname"  style="padding: 0 10px 0 10px;margin-bottom:3px">
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="lastname" id="superLastname"  style="padding: 0 10px 0 10px;margin-bottom:3px">
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="username" required id="superUsername"  style="padding: 0 10px 0 10px;margin-bottom:3px" disabled>
     ...
     <div class="row margin">
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="email" name="email" id="superEmail" required style="padding: 0 10px 0 10px;margin-bottom:3px">
...
<!--  end of the Super admin popup -->
 ...
 <!--  create Add cs admin popup -->
  ...
  <div id="csAdmin" class="modal">
 
  	
  
   <%-- <form:form action="registerCSAdmin?user=${user}&userName=${userName}&locId=${locObj.objectId}" method="post" > --%>
    <a href="#!" class=" modal-action modal-close right waves-effect waves-green btn-flat">Close</a>
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="firstname" id="csFirstname"  style="padding: 0 10px 0 10px;margin-bottom:3px">
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="lastname" id="csLastname" style="padding: 0 10px 0 10px;margin-bottom:3px">
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="username" required id="csUsername"  style="padding: 0 10px 0 10px;margin-bottom:3px" disabled>
     ...
     <div class="row margin">
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="email" name="email" id="csEmail" required style="padding: 0 10px 0 10px;margin-bottom:3px">
...
<!--   start location admin popup -->
  ...
  <div  class="modal locationAdmin">
  
  <%--  <form:form action="registerLocationAdmin?user=${user}&userName=${userName}&locId=${locObj.objectId}" method="post" > --%>
    <a href="#!" class=" modal-action modal-close right waves-effect waves-green btn-flat">Close</a>
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="firstname" id="locationFirstname" style="padding: 0 10px 0 10px;margin-bottom:3px">
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="lastname" id="locationLastname" style="padding: 0 10px 0 10px;margin-bottom:3px">
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="username" id="locationUsername" required style="padding: 0 10px 0 10px;margin-bottom:3px" disabled>
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="email" name="email" id="locationEmail" required style="padding: 0 10px 0 10px;margin-bottom:3px">
		    	...
		    	$.ajax({
				      ...
				      success :function(result) {
				    	  ...
				    	  else
				    	  {
				    		  ...
				    		  $('#userbody').remove();
				    		  $('.userSpin').hide();
					    	  var tableDetails = "<tbody><td style='padding: 6px 0px 0px 0px;text-align:center;''><b style='color:#337ab7;font-size:18px'>User Name</b></td>"+
			    	...
			    	$.ajax({
					      ...
					      success :function(result) {
					    	  ...
					    	  else
					    	  {
						    	  ...
						    	  {
						    		  var table = "<tr>"+
											"<td style='padding: 6px 0px 0px 30px;'> <a style='color:#337ab7' href='select?user=${user}&amp;userName=${userName}&amp;locId="+result[i].templateId+"'>"+
											""+result[i].templateName+""+
											"</a>"+
											"</td>"+
											"<td style='padding:10px 0'> <a href='select?user=${user}&amp;userName=${userName}&amp;locId="+result[i].templateId+"' style='color:#337ab7'>"+
											""+result[i].templateId+""+
											"</a>"+
											"</td>"+				
										"</tr><tbody>";
