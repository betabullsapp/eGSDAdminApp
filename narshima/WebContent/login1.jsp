...
<body>
	...
	<div id="login-page" class="row">
		<div class="col s12 z-depth-4 card-panel">
			<form class="login-form" action="Admin/login" commandName="login" method="post" enctype="multipart/form-data">
				<div class="row">
					<div class="input-field col s12 center">
						<img src="http://betabullsapp.github.io/eGSD/img/logo1.gif" alt="" style="width: 12%;height: 50px !important"
				...
				<div class="row margin">
					<div class="input-field col s12">
						...
						<input id="username" type="text" name="username" required style="padding: 0 10px 0 10px">
				...
				<div class="row margin">
					<div class="input-field col s12">
						...
						<input id="password" type="password" name="password" required style="padding: 0 10px 0 10px">
